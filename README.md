...
cd zecwallet
/path/to/qt5/bin/qmake zecwallet.pro CONFIG+=debug
make -j$(nproc)
...
git clone https://github.com/ZcashFoundation/zecwallet.git
cd zecwallet
c:\Qt5\bin\qmake.exe zecwallet.pro -spec win32-msvc CONFIG+=debug
nmake
...
```
c:\Qt5\bin\qmake.exe zecwallet.pro -tp vc CONFIG+=debug
```
...
For support or other questions, tweet at [@zecwallet](https://twitter.com/zecqtwallet) or [file an issue](https://github.com/ZcashFoundation/zecwallet/issues).
